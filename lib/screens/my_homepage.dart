...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('해위'),leading: Icon(Icons.close),),
      body: Stack(
        ...
        children: [
          Row(
              ...
              children: [Image.asset('assets/images/eos_logo.png',width: 50,height:50,),
          ...
          Positioned(top:50,left:50,child:
          Container(
            width: 100,
            height: 100,
            color: Colors.blue,
